...
public class AuthService implements AuthServiceDefintion {
    ...
    @Override
    public ResponseEntity<JwtToken> signUp(SignUpRequest request) {
        ...
        JwtToken token = new JwtToken(this.jwtService.generateToken(request.getEmail()));
        return new ResponseEntity<>(token , HttpStatus.CREATED);
    }
    

    @Override
    public ResponseEntity<JwtToken> signIn(AuthRequest request) {
