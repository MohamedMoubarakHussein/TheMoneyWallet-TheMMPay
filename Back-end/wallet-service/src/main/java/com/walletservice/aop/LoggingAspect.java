...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.themoneywallet..*(..)) && !within(jakarta.servlet.Filter+) && !within(org.springframework.web.filter..*) &&!within(com.themoneywallet.authenticationservice.config.Security..*)")
    public void myPath(){
